    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            console.log('Found button for 5:30 tomorrow');
            _context5.next = 10;
          ...
          case 13:
            ...
            console.log('5:30 is unavailable for tomorrow');
            return _context5.abrupt("return", null);
...
(function () {
  var _example = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var driver, loginLink, usernameField, passwordField, loginButton, nextDay, cells, availableCells, didSelect, addToCart, memberContainers, submitButton;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 51:
            _context3.next = 53;
            return driver.findElements(_seleniumWebdriver.By.className('webaddtocartmatrix_membergroup'));
